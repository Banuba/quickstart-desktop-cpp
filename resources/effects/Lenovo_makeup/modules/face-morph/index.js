...
class FaceMorph {
    ...
    **/
    eyebrows(params) {
        ...
        if (typeof params === "object") {
            params.spacing && morphs_00_vec4.x(params.spacing);
            params.height && morphs_00_vec4.y(params.height);
            params.bend && morphs_00_vec4.z(params.bend);
        }
    }
    ...
    **/
    eyes(params) {
        ...
        if (typeof params === "object") {
            ...
            params.lower_eyelid_pos && morphs_08_vec4.x(params.lower_eyelid_pos);
            params.lower_eyelid_size && morphs_08_vec4.y(params.lower_eyelid_size);
        }
    }
    ...
    **/
    nose(params) {
        ...
        if (typeof params === "object") {
            params.width && morphs_08_vec4.w(params.width);
            params.length && morphs_08_vec4.z(params.length);
            params.tip_width && morphs_12_vec4.x(params.tip_width);
        }
    }
    ...
    **/
    lips(params) {
        ...
        if (typeof params === "object") {
            params.size && morphs_12_vec4.z(params.size);
            params.height && morphs_12_vec4.y(params.height);
            params.thickness && morphs_12_vec4.w(params.thickness);
            params.mouth_size && morphs_16_vec4.x(params.mouth_size);
            params.smile && morphs_16_vec4.y(params.smile);
            params.shape && morphs_16_vec4.z(params.shape);
        }
    }
    ...
    **/
    face(params) {
        ...
        if (typeof params === "object") {
            params.narrowing && morphs_16_vec4.w(params.narrowing);
            params.v_shape && morphs_20_vec4.x(params.v_shape);
            params.cheekbones_narrowing && morphs_20_vec4.y(params.cheekbones_narrowing);
            params.cheeks_narrowing && morphs_20_vec4.z(params.cheeks_narrowing);
            params.jaw_narrowing && morphs_20_vec4.w(params.jaw_narrowing);
            params.chin_shortening && morphs_24_vec4.x(params.chin_shortening);
            params.chin_narrowing && morphs_24_vec4.y(params.chin_narrowing);
            params.sunken_cheeks && morphs_24_vec4.z(params.sunken_cheeks);
            params.cheeks_jaw_narrowing && morphs_24_vec4.w(params.cheeks_jaw_narrowing);
        }
    }
    /** Resets all morphs */
    clear() {
